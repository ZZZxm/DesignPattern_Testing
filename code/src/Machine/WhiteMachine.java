 ...
 *
 * @author liyuanfeng
 * @function 实现机器接口，实现的机器接口可以提供制作白巧克力的功能
...
public class WhiteMachine implements Machine
{
    ...
    public WhiteMachine()
    {
        System.out.println("成功创建一台白巧克力生产机");
    ...
    public void init()
    {
        System.out.println("机器初始化中，即将开始生产白巧克力...");
        chocolate.initColor(2);//设置为白巧克力
    ...
    public void baking()
    {
        System.out.println("正在对白巧克力原料进行烘培...");
        chocolate.cook1();
    ...
    {
        System.out.println("正在对烘焙后的白巧克力原料进行精炼...");
        chocolate.cook2();
        chocolate.printState();
    }
    ...
    public void cooling()
    {
        System.out.println("正在对精炼后的白巧克力原料进行冷却和塑形...");
        chocolate.cook3();
        chocolate.printState();
    }
    ...
    public void cutting()
    {
        System.out.println("正在对生产的白巧克力进行切割...");
        ...
        System.out.println("成功将白巧克力切割成条形");
        chocolate.cook4();
        chocolate.printState();
    }
