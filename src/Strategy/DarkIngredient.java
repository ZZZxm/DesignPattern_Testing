...
/**
 * 添加原料的接口的实现类，实现添加黑巧克力原料
 
 * @function 工人添加黑巧克力原料
 * @pattern 策略模式(Strategy)
 * @author liyuanfeng
 */
public class DarkIngredient implements IngredientStrategy
{
    /**
    ...
    public void addIngredients()
    {
        ...
        System.out.println("功能描述：采用相应的策略将相应原料添加到机器中");
        System.out.println("======================================");
        System.out.println("当前使用的是添加黑巧克力原料包策略");
        Bags ingredientBag = PackageCreate.create(Const.BLACK_PACKAGE);
        ingredientBag.show();
        System.out.println("成功将黑巧克力原料包加入了机器中！");
        System.out.println("仓库POWDER减少20");
