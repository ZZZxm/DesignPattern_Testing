 ...
 * @author hezehua
 */
public class ProduceDarkChocolate extends ProduceChocolate {
     ...
     * @param worker 工人
     */
    public ProduceDarkChocolate(Machine m, Worker worker)
    {
        this.m = m;
        this.worker = worker;
    ...
    {
        IngredientStrategy strategy = new DarkIngredient();
